...
{
    public class BuildSetting : ISupportInitialize //该接口用于序列化,在属性分配完成后,执行对应的方法？
    {
        [DisplayName("项目名称")]
        ...
        public List<BuildItem> items { get; set; } = new List<BuildItem>(); //有个疑问,这个list是怎么有东西的,反序列化直接给的
        ...
        public void EndInit()//在序列化后执行的操作?
        {
